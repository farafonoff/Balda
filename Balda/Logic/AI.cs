...
namespace Balda.Logic
{
    public class HardnessLevel
    {
        ...
        public static HardnessLevel Easy = new HardnessLevel(AppResources.hdEasy,3, 0.9);
        public static HardnessLevel Medium = new HardnessLevel(AppResources.hdMedium,4, 0.6);
        public static HardnessLevel Hard = new HardnessLevel(AppResources.hdHard,4, 0.3);
        public static HardnessLevel Full = new HardnessLevel(AppResources.hdFull,99, 0);
    ...
    public class AI
    {
        ...
        public BruteResult makeTurn(Field f)
        {
            ...
            foreach (LPosition root in roots)
            {
                ...
                //System.Diagnostics.Debug.WriteLine(root.x + " " + root.y);
        ...
        private BruteResult bruteOld(Field f, LPosition root, bool newLetterUsed, TrieNode wpos)
        {
            ...
            BruteResult result = null;
            if (!wpos.blacklist && wpos.terminal && newLetterUsed && !Player.usedWords.contains(wpos.word))
            {
